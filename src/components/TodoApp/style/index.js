export const styles = {
  ...
  draggerMachine: 'px-4 my-2 transition-colors duration-150 ease-in-out bg-white rounded-lg shadow hover:bg-gray-100',
  dropper: 'w-auto min-w-1/4 max-w-1/2',
  dropperDestination: 'w-auto bg-gray-500 rounded-md',
  ...
  dropOver: 'bg-gray-400 rounded-xl',
};
